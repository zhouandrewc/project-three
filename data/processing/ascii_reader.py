...
class ascii_:
    def __init__(self, f_path, f_name, indiv=False):
    ...
    def _get_csv_path(self):
        return os.path.join(self.file_path, "../../csv/" + self.file_name + '.csv')

    def _get_pickle_path(self):
        return os.path.join(self.file_path, "../../pickle/" + self.file_name + '.pickle')
